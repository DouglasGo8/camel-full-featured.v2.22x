package com.douglasdb.camel.feat.core.ftp.multicast;
 ...
 *
 */
public class OrderWithParallelMulticastRoute extends RouteBuilder{

	
	public OrderWithParallelMulticastRoute() {
